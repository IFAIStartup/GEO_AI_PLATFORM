...
def main():
    ...
    save_dir = check_save_dir(os.path.join(os.path.dirname(__file__), '..', 'outs/360_wo_las'))
    ...
    cfg = Config()
    get_pcd_localization_without_las(img_paths, model_info_list, client, save_shp_path, cfg)
