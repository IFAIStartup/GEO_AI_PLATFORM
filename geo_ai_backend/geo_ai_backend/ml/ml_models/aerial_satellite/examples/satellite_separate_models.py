...
def main():
    img_path = os.path.join(os.path.dirname(__file__), '..', 'inputs', 'AAM DevelopedArea 30cm_1_3.tif')
    ...
    yolo3_model_info = ModelInfo(
        model_name='satellite_palm_tree',
        model_type=ModelTypeEnum.yolov8,
        class_names=['palm_tree'],
        tile_size=640,
        scale_factor=1,
    )
    yolo4_model_info = ModelInfo(
        model_name='satellite_farms',
        model_type=ModelTypeEnum.yolov8,
        class_names=['farms'],
        tile_size=640,
        scale_factor=0.25,
    ...
    deeplab_model_info = ModelInfo(
        model_name='satellite_deeplabv3_plus_26012024',
